...
argument-hint: "[client and period, or the accounts to reconcile]"
---

# /reconcile

Load `${CLAUDE_PLUGIN_ROOT}/skills/financial-close/reconcile/SKILL.md` and follow it end-to-end.
